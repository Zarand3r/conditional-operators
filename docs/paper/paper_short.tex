...
The fourth boundary calls for a consistency objective on the representation, which we are
testing next. Related work has learned group actions on latents for world models
