...
pre-registered gates. The same structure yields a guidance knob needing no second forward pass,
...
and failed the same criterion by $0.065$ percentage points. The penalty is a property of the
operator, not of the basis.
